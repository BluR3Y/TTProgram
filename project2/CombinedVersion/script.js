...
const targetTime = "November 21 2022 UTC-1000";
// countdown function
function timeLeft() {
  const totalTime = Date.parse(targetTime) - Date.parse(new Date()),
  // parse data time into milliseconds
...
document.getElementById("days").innerHTML = timeLeft(targetTime).days + "d",
document.getElementById("hours").innerHTML = timeLeft(targetTime).hours + "h",
document.getElementById("minutes").innerHTML = timeLeft(targetTime).minutes + "m",
document.getElementById("seconds").innerHTML = timeLeft(targetTime).seconds + "s";
},1000)
setInterval(function() {
    document.getElementById("days2").innerHTML = timeLeft(targetTime).days +"d",
    document.getElementById("hours2").innerHTML = timeLeft(targetTime).hours + "h",
    document.getElementById("minutes2").innerHTML = timeLeft(targetTime).minutes + "m",
    document.getElementById("seconds2").innerHTML = timeLeft(targetTime).seconds + "s";
    },1000)

function timeExpand() {
    if (document.getElementById('timeExpand')) {

        if (document.getElementById('timeExpand').style.display == 'none') {
            document.getElementById('timeExpand').style.display = 'block';
            document.getElementById('timeShrink').style.display = 'none';
            document.getElementById('timeExpand').style.WebkitTransition = 'opacity 1s';
        }
        else {
            document.getElementById('timeExpand').style.display = 'none';
            document.getElementById('timeShrink').style.display = 'block';
        }
    }
}
function timeShrink() {
    if (document.getElementById('timeShrink')) {

        if (document.getElementById('timeShrink').style.display == 'none') {
            document.getElementById('timeShrink').style.display = 'block';
            document.getElementById('timeExpand').style.display = 'none';
        }
        else {
