...
def food():
    ...
    if request.method == 'POST':
        ...
        db.execute('insert into food (name, protein, carbohydrates, fat, calories) calues (?, ?, ?, ?, ?)', \
...
#         d = datetime.strftime(str(i['entry_date']), '%Y%m%d')
#         single_date['pretty_date'] = datetime.strptime(d, '%B%d, %Y')
